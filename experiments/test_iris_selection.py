...
def run():
    ...
    print("\r\n\r\n\r\n")
    print("######## Experiment: testIrisSelection ########")
    ...
    selection_strategies = [RankSelection()]



    for selection_strategy in selection_strategies:
        print("######## Selection strategy: " + str(selection_strategy.name) + " ########")

        for max_number_iteration in range(10, 511, 50):
            print("######## Iteration : " + str(max_number_iteration) + " ########")
